...
public class UsbCameraModule {
    ...
    public Bitmap mBitmap = Bitmap.createBitmap(MyConstants.DEFAULT_USB_CAM_WIDTH, MyConstants.DEFAULT_USB_CAM_HEIGHT, Bitmap.Config.RGB_565);

    private static int DEFAULT_WIDTH = MyConstants.DEFAULT_USB_CAM_WIDTH;
    private static int DEFAULT_HEIGHT = MyConstants.DEFAULT_USB_CAM_HEIGHT;
