...
public static abstract class Stub extends android.os.Binder implements com.company.uvc.IUVCSlaveService
{
 ...
 */
public static com.company.uvc.IUVCSlaveService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.company.uvc.IUVCSlaveService))) {
return ((com.company.uvc.IUVCSlaveService)iin);
}
return new com.company.uvc.IUVCSlaveService.Stub.Proxy(obj);
}
...
_arg3 = (0!=data.readInt());
    com.company.uvc.IUVCServiceOnFrameAvailable _arg4;
_arg4 = com.company.uvc.IUVCServiceOnFrameAvailable.Stub.asInterface(data.readStrongBinder());
...
private static class Proxy implements com.company.uvc.IUVCSlaveService
{
...
@Override public void addSurface(int serviceID, int id_surface, android.view.Surface surface, boolean isRecordable, com.company.uvc.IUVCServiceOnFrameAvailable callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public void addSurface(int serviceID, int id_surface, android.view.Surface surface, boolean isRecordable, com.company.uvc.IUVCServiceOnFrameAvailable callback) throws android.os.RemoteException;
