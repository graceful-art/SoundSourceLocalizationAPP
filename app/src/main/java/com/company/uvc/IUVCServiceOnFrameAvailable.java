...
public static abstract class Stub extends android.os.Binder implements com.company.uvc.IUVCServiceOnFrameAvailable
{
 ...
 */
public static com.company.uvc.IUVCServiceOnFrameAvailable asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.company.uvc.IUVCServiceOnFrameAvailable))) {
return ((com.company.uvc.IUVCServiceOnFrameAvailable)iin);
}
return new com.company.uvc.IUVCServiceOnFrameAvailable.Stub.Proxy(obj);
}
...
private static class Proxy implements com.company.uvc.IUVCServiceOnFrameAvailable
{
